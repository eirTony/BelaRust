...
void ModuleInfo::doConstruct(void) {TRACE("in ModuleInfo::%1()", "doConstruct");}
void ModuleInfo::doExecute(void) {TRACE("in ModuleInfo::%1()", "doExecute");}
void ModuleInfo::doTest(void) {TRACE("in ModuleInfo::%1()", "doTest");}
void ModuleInfo::doInitialize(void) {TRACE("in ModuleInfo::%1()", "doInitialize");}
void ModuleInfo::doConfigure(void) {TRACE("in ModuleInfo::%1()", "doConfigure");}
void ModuleInfo::doStart(void) {TRACE("in ModuleInfo::%1()", "doStart");}
void ModuleInfo::doStop(void) {TRACE("in ModuleInfo::%1()", "doStop");}
void ModuleInfo::doQuit(void) {TRACE("in ModuleInfo::%1()", "doQuit");}
